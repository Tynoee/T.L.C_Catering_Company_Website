...
def add_packages():
    with app.app_context():
        ...
        if existing_packages == 0:
            conn.executescript('''
                INSERT INTO packages (name, description, type, image) VALUES
                ('Classic Elegance Package', '<ul><li><b>Venue:</b> Grand Ballroom</li><li><b>Catering:</b> 4-course gourmet meal with wine</li><li><b>Decorations:</b> Classic floral arrangements and elegant lighting</li><li><b>Music:</b> Live band for 5 hours</li><li><b>Photography:</b> Full-day coverage</li><li><b>Additional Services:</b> Bridal suite, valet parking</li><li><b>Price:</b> $10,000</li></ul>', 'wedding', 'classic_elegance_package.jpg'),
                ('Intimate Ceremony Package', '<ul><li><b>Venue:</b> Private Garden</li><li><b>Catering:</b> 3-course meal with champagne toast</li><li><b>Decorations:</b> Minimalist floral decor and candles</li><li><b>Music:</b> Solo musician for ceremony</li><li><b>Photography:</b> 4-hour coverage</li><li><b>Additional Services:</b> Wedding planner, transportation for couple</li><li><b>Price:</b> $5,000</li></ul>', 'wedding', 'intimate_ceremony_package.jpg'),
                ('Destination Wedding Package', '<ul><li><b>Venue:</b> Beach Resort</li><li><b>Catering:</b> Seafood buffet with tropical cocktails</li><li><b>Decorations:</b> Tropical floral arrangements and tiki torches</li><li><b>Music:</b> Steel drum band</li><li><b>Photography:</b> Full-day coverage with sunset photo shoot</li><li><b>Additional Services:</b> Accommodation for couple, welcome dinner</li><li><b>Price:</b> $20,000</li></ul>', 'wedding', 'destination_wedding_package.jpg'),
